...
def profileSort(sortFunction, upper = 10):
    ...
    t2 = time.time() - t1
    print("Results for a sorted list of numbers:")
...
def main():
    ...
    print("Selection Sort Profile: ")
    profileSort(selectionSort, 15)
    print()
    print("Quick Sort Profile: ")
    profileSort(quickSort, 15)
    print()
    print("Straight Recursion Fibonacci Profile: ")
    profileFib(fib1)
    print()
    print("Fibonacci with Memo Profile: ")
    profileFib(fib2)
